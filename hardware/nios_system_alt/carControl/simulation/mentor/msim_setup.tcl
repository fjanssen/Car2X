...
# ACDS 12.1 177 win32 2014.06.21.12:51:52
...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_irq_mapper.sv"                                -work irq_mapper                                                             
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work rsp_xbar_mux_001                                                       
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_rsp_xbar_mux_001.sv"                          -work rsp_xbar_mux_001                                                       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work rsp_xbar_mux                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_rsp_xbar_mux.sv"                              -work rsp_xbar_mux                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_rsp_xbar_demux_002.sv"                        -work rsp_xbar_demux_002                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_rsp_xbar_demux.sv"                            -work rsp_xbar_demux                                                         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_xbar_mux                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_cmd_xbar_mux.sv"                              -work cmd_xbar_mux                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_cmd_xbar_demux_001.sv"                        -work cmd_xbar_demux_001                                                     
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_cmd_xbar_demux.sv"                            -work cmd_xbar_demux                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_id_router_002.sv"                             -work id_router_002                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_id_router.sv"                                 -work id_router                                                              
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_addr_router_001.sv"                           -work addr_router_001                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/carControl_addr_router.sv"                               -work addr_router                                                            
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                            -work carControl_memory_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                     -work carControl_memory_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                           -work carControl_nios2_data_master_translator_avalon_universal_master_0_agent
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                       -work carControl_memory_s1_translator                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                      -work carControl_nios2_data_master_translator                                
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L limiter -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L carControl_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L carControl_memory_s1_translator_avalon_universal_slave_0_agent -L carControl_nios2_data_master_translator_avalon_universal_master_0_agent -L carControl_memory_s1_translator -L carControl_nios2_data_master_translator -L mm_bridge_0 -L carControl_uart -L carControl_memory -L carControl_nios2 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
