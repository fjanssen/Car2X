...
set 	nios_system_nios2_car_controll 	nios_system_nios2_car_controll:*
set 	nios_system_nios2_car_controll_oci 	nios_system_nios2_car_controll_nios2_oci:the_nios_system_nios2_car_controll_nios2_oci
set 	nios_system_nios2_car_controll_oci_break 	nios_system_nios2_car_controll_nios2_oci_break:the_nios_system_nios2_car_controll_nios2_oci_break
set 	nios_system_nios2_car_controll_ocimem 	nios_system_nios2_car_controll_nios2_ocimem:the_nios_system_nios2_car_controll_nios2_ocimem
set 	nios_system_nios2_car_controll_oci_debug 	nios_system_nios2_car_controll_nios2_oci_debug:the_nios_system_nios2_car_controll_nios2_oci_debug
set 	nios_system_nios2_car_controll_wrapper 	nios_system_nios2_car_controll_jtag_debug_module_wrapper:the_nios_system_nios2_car_controll_jtag_debug_module_wrapper
set 	nios_system_nios2_car_controll_jtag_tck 	nios_system_nios2_car_controll_jtag_debug_module_tck:the_nios_system_nios2_car_controll_jtag_debug_module_tck
set 	nios_system_nios2_car_controll_jtag_sysclk 	nios_system_nios2_car_controll_jtag_debug_module_sysclk:the_nios_system_nios2_car_controll_jtag_debug_module_sysclk
set 	nios_system_nios2_car_controll_oci_path 	 [format "%s|%s" $nios_system_nios2_car_controll $nios_system_nios2_car_controll_oci]
set 	nios_system_nios2_car_controll_oci_break_path 	 [format "%s|%s" $nios_system_nios2_car_controll_oci_path $nios_system_nios2_car_controll_oci_break]
set 	nios_system_nios2_car_controll_ocimem_path 	 [format "%s|%s" $nios_system_nios2_car_controll_oci_path $nios_system_nios2_car_controll_ocimem]
set 	nios_system_nios2_car_controll_oci_debug_path 	 [format "%s|%s" $nios_system_nios2_car_controll_oci_path $nios_system_nios2_car_controll_oci_debug]
set 	nios_system_nios2_car_controll_jtag_tck_path 	 [format "%s|%s|%s" $nios_system_nios2_car_controll_oci_path $nios_system_nios2_car_controll_wrapper $nios_system_nios2_car_controll_jtag_tck]
...
set_false_path -from [get_keepers *$nios_system_nios2_car_controll_oci_break_path|break_readreg*] -to [get_keepers *$nios_system_nios2_car_controll_jtag_sr*]
set_false_path -from [get_keepers *$nios_system_nios2_car_controll_oci_debug_path|*resetlatch]     -to [get_keepers *$nios_system_nios2_car_controll_jtag_sr[33]]
set_false_path -from [get_keepers *$nios_system_nios2_car_controll_oci_debug_path|monitor_ready]  -to [get_keepers *$nios_system_nios2_car_controll_jtag_sr[0]]
set_false_path -from [get_keepers *$nios_system_nios2_car_controll_oci_debug_path|monitor_error]  -to [get_keepers *$nios_system_nios2_car_controll_jtag_sr[34]]
set_false_path -from [get_keepers *$nios_system_nios2_car_controll_ocimem_path|*MonDReg*] -to [get_keepers *$nios_system_nios2_car_controll_jtag_sr*]
