...
// Import interface
#include "../networking/ADCValuesMessage.h"
#include "../networking/ADCInfoMessage.h"
...
CCarMessage *CADCSensor::getCarMessage()
{
	...
	else
	{
		...
		p_carMessage = (CCarMessage *) new CADCValuesMessage(m_uiChannelsConnected, m_uiChannelNumbers);
	}
...
bool CADCSensor::wasInitialised()
{
	return m_bWasInitialised;
}
