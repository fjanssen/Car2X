...
$(MEM_0)_HIERARCHICAL_PATH := CPU0_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: CPU0_memory
CPU0_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: Comms_memory
MEM_1 := Comms_memory
$(MEM_1)_NAME := Comms_memory
...
$(MEM_1)_END := 0x00041fff
$(MEM_1)_HIERARCHICAL_PATH := Comms_memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: Comms_memory
Comms_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
