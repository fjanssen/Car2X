...
#define C2X_MSGID_EMERGENCY_BRAKE (0x10)
#define C2X_MSGID_CONTROL         (0x20)
#define C2X_MSGID_INFO_STATE      (0x30)
#define C2X_MSGID_INFO_SENSORS    (0x31)

#define C2X_REQUEST_FLAG          (0x8000)
