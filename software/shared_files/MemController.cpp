...
{
	return getElement<T>(areaId, 0, false);
}

template<typename T> T MemController::getLastElement(MemController::AreaId areaId, bool blocking)
{
	return getElement<T>(areaId, 0, blocking);
}
