...
JDI_FILE := C:/Users/wji/car2x/repo/hardware/myfirst_niosii.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := C:/Users/wji/car2x/repo/hardware/DE2_115_SOPC.sopcinfo
...
# setting hal.stderr is CPU0_JTAG_UART
ELF_PATCH_FLAG  += --stderr_dev CPU0_JTAG_UART

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is CPU0_JTAG_UART
ELF_PATCH_FLAG  += --stdin_dev CPU0_JTAG_UART
...
# setting hal.stdout is CPU0_JTAG_UART
ELF_PATCH_FLAG  += --stdout_dev CPU0_JTAG_UART
